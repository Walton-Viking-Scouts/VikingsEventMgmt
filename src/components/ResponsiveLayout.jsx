          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-amber-700">
                <strong>Offline Mode:</strong> Your authentication has expired, but you can still access cached data. Connect to WiFi and refresh to re-authenticate with OSM.
              </p>
            </div>
          </div>
        </div>
