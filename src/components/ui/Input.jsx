...
const Input = forwardRef(({ 
  ...
  const baseClasses = 'w-full rounded-md border transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-1 disabled:opacity-50 disabled:cursor-not-allowed';
  
  const variants = {
    default: 'border-gray-300 bg-white text-gray-900 placeholder-gray-500 focus:border-scout-blue focus:ring-scout-blue/20',
    scout: 'border-scout-blue bg-white text-gray-900 placeholder-gray-500 focus:border-scout-blue-dark focus:ring-scout-blue/30',
  };
