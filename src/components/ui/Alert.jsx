...
const Alert = ({
  ...
  return (
    <div
      ...
      data-oid="hdxyiwg"
    >
      <div className="flex" data-oid="i87.i5v">
        {icon && (
          <div className="flex-shrink-0" data-oid="hyp7ah_">
            {icons[variant] || icons.info}
          </div>
        )}

        <div className={cn("flex-1", icon && "ml-3")} data-oid="-j2rtzq">
          {children}
        </div>
...
const AlertDescription = ({ children, className = "", ...props }) => {
  return (
    <div className={cn("text-sm", className)} {...props} data-oid="43t_5v_">
      {children}
    </div>
  );
};
