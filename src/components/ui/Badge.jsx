...
const Badge = ({ 
  ...
  const variants = {
    ...
    'outline-scout-green': 'border border-scout-green text-scout-green bg-white',
    'outline-scout-red': 'border border-scout-red text-scout-red bg-white',
    'outline-scout-forest-green': 'border border-scout-forest-green text-scout-forest-green bg-white',
    'outline-scout-purple': 'border border-scout-purple text-scout-purple bg-white',
