...
import { findMemberSectionType, findMemberSectionName } from '../../../shared/utils/sectionHelpers.js';
...
function CampGroupsView({
  ...
  }, [events, attendees, members]); // Removed pendingMoves and recentlyCompletedMoves to prevent unnecessary reloads
