...
function SignInOutButton({ 
  ...
  return (
    <button
      ...
      className={`inline-flex items-center justify-center rounded-md font-medium px-3 py-2 min-h-[44px] text-sm transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed ${
        isSignedIn
