...
must_haves:
  truths:
    ...
    - "The compound keyPath ['eventid', 'scoutid'] serves as the primary compound index for the attendance store. Individual secondary indexes on 'eventid', 'scoutid', and 'sectionid' provide the efficient lookup paths required by ATTN-02. No separate composite multi-column index is needed because the compound keyPath IS the primary index."
